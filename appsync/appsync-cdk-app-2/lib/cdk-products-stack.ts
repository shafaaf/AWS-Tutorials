 ...
 export class CdkProductsStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);
      ...
      // create a Cognito User Pool that will enable the user to sign in with a username, email address, and password.
    ...
    // creating an AppSync GraphQL API with two types of authentication: API Key (public access) and
    // Amazon Cognito User Pool (private, authenticated access)
    const api = new appsync.GraphqlApi(this, 'appsync-cdk-app-2', {
